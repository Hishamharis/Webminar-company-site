...
const services = [
  { number: "01", title: "AI Systems", description: "Agents, copilots, and intelligent workflows that turn ambitious ideas into useful products.", icon: "✦" },
  { number: "02", title: "Cloud Native", description: "Fast, resilient infrastructure designed to scale from first users to millions.", icon: "⌁" },
  { number: "03", title: "DevOps Flow", description: "Clean delivery pipelines that keep teams shipping confidently, every single day.", icon: "↗" },
];
...
export default function App() {
  ...
  useEffect(() => {
    ...
    document.querySelector('meta[name="description"]')?.setAttribute("content", "AI-native product engineering for the next generation of the web.");
  }, []);
  ...
  return <main>
    ...
    <nav className="nav-shell" aria-label="Main navigation">
      ...
      <div className={`nav-links ${menuOpen ? "is-open" : ""}`}>
        <a href="#work" onClick={closeMenu}>Work <span>↗</span></a><a href="#services" onClick={closeMenu}>Services <span>↗</span></a><a href="#about" onClick={closeMenu}>About <span>↗</span></a>
      </div>
      <a href="#contact" className="nav-cta" onClick={closeMenu}>Start a project <span>↗</span></a>
    </nav>

    <section className="hero" id="top"><div className="hero-copy"><p className="eyebrow"><i /> Independent digital studio · Est. 2024</p><h1>Build<br /><em>what&apos;s next.</em></h1><p className="hero-description">We partner with bold teams to shape ambitious ideas into intelligent, high-performance digital products.</p><div className="hero-actions"><a href="#contact" className="button button-light">Let&apos;s talk <span>↗</span></a><a href="#work" className="text-link">Explore our work <span>↓</span></a></div></div><Orbit /><div className="hero-index">01 <span>/</span> 03</div></section>
    <section className="marquee" aria-label="Capabilities"><div>AI-FIRST <span>✦</span> HUMAN-LED <span>✦</span> FUTURE-READY <span>✦</span> AI-FIRST <span>✦</span> HUMAN-LED <span>✦</span></div></section>
    <section className="intro section-pad" id="about"><p className="section-kicker">/ The way we work</p><div className="intro-grid"><h2>Good technology<br /><em>feels inevitable.</em></h2><div><p className="large-copy">We believe the best digital experiences sit at the intersection of clarity, craft, and curiosity.</p><p className="muted-copy">No bloated process. No unnecessary noise. Just thoughtful strategy, sharp design, and engineering that makes complex things feel simple.</p></div></div></section>
